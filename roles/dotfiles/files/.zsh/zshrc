...
# without polluting main scope with a bunch of identifiers.
...
# }}}
# exclude path-directories from the tag-order {{{
...
# $2 is one-line (truncated) version of
# the command.
